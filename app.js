...
function hitMe() {
    if (((score) <= 21)) {
        ...
        document.querySelector(".card" + botTurn).style.background = "url('./files/my-order/" + randomCard[0] + "_of_" + randomCard[1] + ".png') no-repeat 0 0";
    }
    else {
        AIturn();
    }
...
function init() {
    ...
    cardDrawnContainer.style.background = 'url("./start.jpg")';  
    cardDrawnContainer.style.transform = "scale(0.7)";
    for (let i = 1; i <= 4; i++) {
